...
$(function () {
    ...
    After the function updateCount, you needed parenthesis.()
    #################################################*/
    ...
    $newItemForm.on("submit", function(e) {
        ...
        $list.append("<li>" + text.toLowerCase() + "</li>"); // Add item to end of the list
    ...
    Couldn't fix this one. I messed around with .addClass("favorite")
    but I didn't know exactly what to do with it.
    #################################################*/
